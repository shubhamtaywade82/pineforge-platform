...
export const TIMELINE_PHASES: TimelinePhase[] = [
  withProgress({
    ...
    milestones: [
      ...
      { id: "m08", task: "Version history — IndicatorVersion + create_version!", done: true },
      { id: "m09", task: "Diffs — version diff API + Monaco DiffEditor", done: true },
    ...
    deliverable: "Single-turn generation live. Valid v6 streams into Monaco with diagnostics.",
  }),
  withProgress({
    id: "intelligence",
    label: "Intelligence",
